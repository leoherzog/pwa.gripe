...
FEATURES = [
    ...
    ("Media Capture", "stream", "'mediaDevices' in navigator"),
    ("Picture-in-Picture", "picture-in-picture", "'documentPictureInPicture' in window"),
    ...
    ("Viewport", None, "'virtualKeyboard' in navigator"),
    ...
    ("Screen Capturing", "mediacapture-fromelement", "'getDisplayMedia' in navigator.mediaDevices"),
